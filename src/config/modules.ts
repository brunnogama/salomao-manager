...
export const MODULE_CONFIG = {
  ...
  collaborators: {
    ...
    descriptions: {
      ...
      comunicacoes: 'Central de comunicados corporativos.',
      vagas: 'Gestão de processos seletivos abertos.',
      postos: 'Alocação de postos físicos de trabalho.',
      acoes: 'Gestão de endomarketing, eventos e campanhas.',
      organograma: 'Estrutura hierárquica e setorial.',
  ...
  financial: {
    ...
    descriptions: {
      ...
      'controle-financeiro': 'Gestão de faturamento e recebíveis.',
