...
interface SecretariaExecutivaGEDProps {
  userName?: string;
  onModuleHome?: () => void;
  onLogout?: () => void;
}

export function SecretariaExecutivaGED({ 
  userName = 'Usuário', 
  onModuleHome, 
  onLogout 
}: SecretariaExecutivaGEDProps) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-gray-500 mt-0.5">
              Gestão Eletrônica de Documentos, Atas e Ofícios Administrativos
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6 w-full">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative w-full md:w-96">
            ...
            <input 
              type="text"
              placeholder="Buscar documento ou ata..."
              value={searchTerm}
        ...
        <div className="bg-blue-50/50 border border-blue-100 p-4 rounded-xl flex items-center gap-4">
           ...
           <p className="text-xs font-semibold text-[#1e3a8a]/80">
             Repositório seguro de arquivos executivos. Acesso restrito conforme níveis de hierarquia administrativa.
           </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-16 flex flex-col items-center justify-center text-center">
            ...
            <h2 className="text-xl font-black text-[#0a192f]">Nenhum arquivo encontrado</h2>
            <p className="text-gray-500 max-w-sm mt-2 font-medium">
              Não existem documentos digitais armazenados nesta pasta ou que correspondam à sua busca.
            </p>
          </div>
        </div>
