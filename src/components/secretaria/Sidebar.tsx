      ...
      `}>
        ...
        <div className="p-6 pb-2">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-sm font-bold text-white leading-none tracking-wide">SECRETARIA</h2>
              <h2 className="text-xl font-black text-white leading-none tracking-wide mt-0.5">EXECUTIVA</h2>
            </div>
          </div>
          {/* Separator */}
