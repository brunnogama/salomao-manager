    ...
    return (
      <div className="space-y-1 flex flex-col h-full relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div 
          ...
          className={`w-full h-[38px] px-3 flex items-center justify-between bg-gray-100/50 border rounded-xl text-xs transition-all cursor-pointer group ${
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="space-y-1 flex flex-col h-full">
                ...
                <input type="date" name="vencimento" value={formData.vencimento} onChange={(e) => setFormData({...formData, vencimento: e.target.value})} className="w-full h-[38px] px-3 bg-gray-100/50 border border-gray-200 rounded-xl text-xs outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-medium text-gray-700" required />
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div className="space-y-1 flex flex-col h-full">
                ...
                <button type="button" onClick={() => setIsRateioModalOpen(true)} className="w-full h-[38px] flex items-center justify-between px-3 bg-white border border-dashed border-gray-200 text-gray-700 rounded-xl text-[11px] font-semibold hover:border-blue-400 transition-all">
              ...
              <div className="space-y-1 flex flex-col h-full">
                ...
                <input type="date" name="data_envio" value={formData.data_envio} onChange={(e) => setFormData({...formData, data_envio: e.target.value})} className="w-full h-[38px] px-3 bg-gray-100/50 border border-gray-200 rounded-xl text-xs outline-none text-gray-700" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
              <div className="md:col-span-2 space-y-1">
                ...
                <input name="descricao_servico" value={formData.descricao_servico} onChange={(e) => setFormData({...formData, descricao_servico: e.target.value})} className="w-full h-[38px] px-4 bg-gray-100/50 border border-gray-200 rounded-xl text-xs outline-none focus:ring-2 focus:ring-blue-500/20 font-medium text-gray-700" placeholder="Resumo do serviço..." />
              </div>
              <div className="space-y-1">
                <label className="text-[9px] font-bold text-gray-500 uppercase tracking-widest px-1">Comprovante (GED)</label>
                <label className="flex items-center gap-2 w-full h-[38px] px-3 border border-dashed border-blue-200 rounded-xl cursor-pointer bg-blue-50/30 hover:bg-blue-50 transition-all">
