...
import { 
  LayoutDashboard, 
  ArrowUpCircle, // Contas a Pagar
  ArrowDownCircle, // Contas a Receber
  Plane, // Gestão da Aeronave
  FolderSearch, // GED
  History, 
  X,
  LogOut
      ...
      `}>
        ...
        <div className="flex flex-col flex-shrink-0 relative bg-[#112240] pt-6 pb-4 px-6">
          <div className="flex flex-col items-center w-full gap-4">
            ...
            />
            <div className="bg-emerald-950/30 border border-emerald-800/30 rounded-lg px-4 py-2 w-full">
              <span className="text-[10px] text-emerald-400 font-bold tracking-[0.25em] uppercase leading-none whitespace-nowrap block text-center">
                Módulo Financeiro
              </span>
            </div>
          </div>
