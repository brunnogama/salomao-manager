        ...
        <div className="flex flex-col md:row gap-4 items-center justify-between">
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full pl-11 pr-4 py-3 bg-white border border-gray-100 rounded-xl shadow-sm focus:ring-2 focus:ring-red-500 outline-none transition-all font-medium text-sm"
            />
          </div>
          ...
          <div className="flex gap-3 w-full md:w-auto">
            ...
            <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600 to-red-800 text-white rounded-xl font-black text-[9px] uppercase tracking-[0.2em] shadow-lg hover:shadow-xl transition-all active:scale-95">
