      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex-1 flex overflow-x-auto pb-4 custom-scrollbar min-h-0">
          <div className="flex gap-4 h-full">
            {COLUMNS.map((column) => (
            <div key={column.id} className={`flex-shrink-0 w-80 lg:w-96 flex flex-col rounded-2xl border-2 shadow-sm transition-all overflow-hidden ${
              ...
              <div className="p-5 flex items-center justify-between bg-white border-b border-gray-100">
                <div className={`flex items-center gap-2.5 font-black text-[11px] uppercase tracking-[0.15em] ${
              ...
              <div className="px-4 py-3 bg-white/50">
                <button 
                  ...
                  className={`w-full py-2.5 rounded-xl text-white text-[9px] font-black uppercase tracking-[0.2em] flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all active:scale-95 ${
                    column.color === 'orange' ? 'bg-[#1e3a8a] hover:bg-[#112240]' : 
                      ...
                      <Draggable key={task.id} draggableId={task.id} index={index}>
                        {(provided, snap) => (
                          <div
                            ...
                            className={`bg-white p-4 rounded-xl shadow-sm border-2 mb-3 hover:border-[#1e3a8a]/30 hover:shadow-md transition-all cursor-pointer group ${
                              snap.isDragging ? 'shadow-2xl rotate-2 border-[#1e3a8a] scale-105 z-50' : 'border-gray-100'
                            }`}
                          >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50/50 p-4 rounded-2xl border border-gray-100">
                      ...
                      <span className={`inline-block px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border shadow-sm ${
