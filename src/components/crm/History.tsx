...
export function History() {
  ...
  return (
    <div className="h-full flex flex-col p-4 sm:p-6 space-y-4 sm:space-y-6 bg-transparent">

      {/* HEADER E ABAS */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex bg-white/50 backdrop-blur-sm p-1 rounded-xl border border-gray-200 shadow-sm w-full sm:w-auto">
          <button
      ...
      {/* BARRA DE FILTROS */}
      <div className="flex flex-col xl:flex-row justify-between items-stretch xl:items-center gap-4 bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-sm border border-white/50">
      ...
      {/* TABELA DE LOGS */}
      <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex flex-col relative overflow-hidden">
