  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm font-semibold text-gray-500 mt-1 sm:mt-0.5">Gestão de contatos e brindes</p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap gap-4">
        {/* Total Gifts Card */}
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col gap-3 flex-1 min-w-[140px] sm:min-w-[180px] transition-all hover:shadow-md">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="p-2 sm:p-3 rounded-xl bg-gradient-to-br from-[#1e3a8a] to-[#112240] shadow-lg shrink-0">
              <Gift className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
            </div>
            <div className="flex-1">
              <p className="text-[8px] sm:text-[9px] font-black text-gray-400 uppercase tracking-[0.2em]">Total de Brindes</p>
              <p className="text-2xl sm:text-[30px] font-black text-[#0a192f] tracking-tight leading-none mt-1">{totalGifts}</p>
            </div>
          </div>
        </div>
        ...
        {['Brinde VIP', 'Brinde Médio', 'Outros'].map((tipo) => {
          ...
          return (
            <div
              ...
              className={`bg-white p-4 sm:p-6 rounded-2xl shadow-sm border-2 flex flex-col gap-3 cursor-pointer hover:shadow-md transition-all flex-1 min-w-[140px] sm:min-w-[180px] active:scale-95 ${filterGiftType === tipo ? 'border-[#1e3a8a] bg-blue-50' : 'border-gray-200 hover:border-[#1e3a8a]/30'
                }`}
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <div className={`p-2 sm:p-3 rounded-xl bg-gradient-to-br ${getGiftIconColor(tipo)} shadow-lg shrink-0`}>
                  <Gift className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
                </div>
                <div className="flex-1">
                  <p className="text-[8px] sm:text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] line-clamp-1">{tipo}</p>
                  <p className="text-2xl sm:text-[30px] font-black text-[#0a192f] tracking-tight leading-none mt-1">{qtd}</p>
                </div>
              </div>
            </div>
          );
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
          ...
          {/* Card de Total */}
          <div className="flex items-center gap-3 pr-4 border-b lg:border-b-0 lg:border-r border-gray-100 pb-4 lg:pb-0">
            <div className="p-2 bg-[#1e3a8a]/10 text-[#1e3a8a] rounded-lg shrink-0">
