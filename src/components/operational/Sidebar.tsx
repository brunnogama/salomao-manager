                ...
                <div className="p-6 pb-2">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <h2 className="text-xl font-black text-white leading-none tracking-wide mt-0.5">OPERACIONAL</h2>
                        </div>
                    </div>
                    {/* Separator */}
                    ...
                    <div className="bg-gradient-to-b from-white/5 to-black/20 rounded-2xl p-4 border border-white/5 shadow-xl backdrop-blur-md">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button
                                ...
                                title="Mudar Módulo"
                            >
                                <LayoutGrid className="w-4 h-4 text-blue-300 group-hover:text-white mb-1" />
