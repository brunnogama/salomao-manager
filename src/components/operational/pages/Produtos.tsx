                        ...
                        {categories.map((cat) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-md whitespace-nowrap transition-all text-xs font-bold uppercase tracking-wider ${activeCategory === cat.id
