    ...
    <div className='bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-all p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-5 gap-4 items-center'>
        ...
        <div className='md:col-span-1 relative'>
          <div className='bg-gradient-to-br from-[#0a192f] to-[#112240] p-5 rounded-xl border border-white/10 shadow-lg text-center group hover:shadow-blue-900/20 transition-all'>
