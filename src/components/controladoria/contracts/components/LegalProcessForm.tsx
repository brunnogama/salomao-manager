                ...
                <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm animate-in fade-in duration-300">
                    {otherProcessType === 'Processo Administrativo' ? (
                        ...
                        <div className="mb-4">
                            ...
                            <textarea className="w-full border border-gray-300 rounded-lg focus:border-salomao-blue outline-none p-2 text-sm font-medium h-24 resize-none" placeholder={`Descreva o assunto...`} value={currentProcess.process_number || ''} onChange={(e) => setCurrentProcess({ ...currentProcess, process_number: e.target.value })} autoFocus />
