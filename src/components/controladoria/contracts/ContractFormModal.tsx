  ...
  const executeSave = async () => {
    ...
    try {
      ...
      const contractPayload: any = {
        ...formData,
        client_id: clientId,
        pro_labore: isTimesheet ? '0' : formData.pro_labore,
        final_success_fee: isTimesheet ? '0' : formData.final_success_fee,
        fixed_monthly_fee: isTimesheet ? '0' : formData.fixed_monthly_fee,
        other_fees: isTimesheet ? '0' : formData.other_fees,
