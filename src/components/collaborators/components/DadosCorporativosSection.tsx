    ...
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <SearchableSelect 
          ...
          options={[{ name: 'Ativo' }, { name: 'Desligado' }, { name: 'Inativo' }]} 
        />
        ...
        <div>
          ...
          <input 
            ...
            onChange={e => setFormData({ ...formData, data_admissao: maskDate(e.target.value) })} 
            maxLength={10} 
        ...
        <div>
          ...
          <input 
            ...
            onChange={e => setFormData({ ...formData, data_desligamento: maskDate(e.target.value) })} 
            maxLength={10} 
            placeholder="DD/MM/AAAA" 
          />
        </div>
