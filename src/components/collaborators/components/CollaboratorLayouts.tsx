...
export const CollaboratorModalLayout = ({
    ...
    return (
        <div className="fixed inset-0 bg-[#0a192f]/80 backdrop-blur-xl z-[9999] flex items-center justify-center p-4 animate-in fade-in duration-300" style={{ WebkitBackdropFilter: 'blur(24px)' }}>
