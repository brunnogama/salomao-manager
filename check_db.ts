...
async function main() {
    console.log('Fetching office_locations (all)...');
    ...
    else console.log('Offices:', JSON.stringify(offices, null, 2));

    console.log('Fetching unique billing_locations from contracts...');
