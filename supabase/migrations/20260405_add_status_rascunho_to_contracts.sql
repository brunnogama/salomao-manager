...
BEGIN
    ...
    -- Cria-se a nova constraint englobando "rascunho" além das tipagens já existentes
    ALTER TABLE contracts ADD CONSTRAINT contracts_status_check CHECK (status IN ('analysis', 'proposal', 'active', 'rejected', 'probono', 'baixado', 'rascunho'));
END $$;
